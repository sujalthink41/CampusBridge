...
class CreateCollegeRequest(BaseModel):
    ...
    is_government: bool = Field(
        default=False, description="Type of college government or private"
    )
...
class CollegeUpdateRequest(BaseModel):
    ...
    name: Optional[str] = Field(default=None, description="Name of the college")
    is_government: Optional[bool] = Field(
        default=None, description="Whether the college is government or private"
    )
    state: Optional[StateEnum] = Field(
        default=None, description="State in which the college is present"
    )
    city: Optional[str] = Field(
        default=None, description="City in which the college is present"
    )
...
class CollegeDeleteResponse(BaseModel):
    ...
    message: str = Field(description="Message confirming college deletion")

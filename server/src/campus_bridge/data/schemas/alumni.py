...
class CreateAlumni(AlumniBase):
    ...
    college_id: Optional[UUID] = Field(None, description="College ID for the alumni profile")
...
class UpdateAlumni(BaseModel):
    ...
    experience_years: Optional[int] = Field(description="Experience years of the alumni")
    expertise_areas: Optional[dict] = Field(description="Expertise areas of the alumni")
    is_available: Optional[bool] = Field(description="Is the alumni available for mentorship")

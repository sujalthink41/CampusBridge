...
from campus_bridge.data.enums.post import PostTypeEnum, PostVisibilityEnum
...
class PostCreate(BaseModel):
    ...
    content: str = Field(
        ..., min_length=1, max_length=5000, description="The content of the post"
    )
    post_type: PostTypeEnum = Field(..., description="The type of the post")
    visibility: PostVisibilityEnum = Field(
        ..., description="The visibility of the post"
    )
    metadata: dict | None = Field(
        default_factory=dict, description="The metadata of the post"
    )
...
class PostUpdateRequest(BaseModel):
    ...
    post_type: Optional[PostTypeEnum] = Field(
        default=None, description="The type of the post"
    )
    visibility: Optional[PostVisibilityEnum] = Field(
        default=None, description="The visibility of the post"
    )
    metadata: Optional[dict] = Field(
        default=None, description="The metadata of the post"
    )

...
@router.patch("/{college_id}", response_model=CollegeResponse, status_code=status.HTTP_200_OK)
...
@router.delete("/{college_id}", response_model=CollegeDeleteResponse, status_code=status.HTTP_200_OK)

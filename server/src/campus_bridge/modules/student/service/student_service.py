...
from campus_bridge.modules.student.repository.student_repository import StudentRepository, get_student_repository
from campus_bridge.data.schemas.student import StudentUserResponse, StudentResponse, StudentUpdateRequest, StudentUpdateResponse, StudentCreate
...
class StudentService:
    ...
    async def get_all_students_by_college(self, college_id: UUID) -> list[StudentUserResponse]:
    ...
    async def create_student(self, student: StudentCreate, user: User) -> StudentResponse:
    ...
    async def update_student(self, student: StudentUpdateRequest, user: User) -> StudentUpdateResponse:

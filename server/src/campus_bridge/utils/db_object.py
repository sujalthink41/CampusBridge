...
def get_database_native_name(name: str, type: DATABASE_SCHEMA_OBJECT) -> str:
    """
    Utility function to get the Database Native Name.
...
def get_foreign_key(model_name: str, field_name: str = "id") -> str:
    """
    Utility function to get the Foreign Key Name.

    Args:
        model_name: Name of the model.
        field_name: Name of the field. Default to "id".

    Returns:
        str: Foreign Key Name.
    """
